...
class MainWindow:
    def __init__(self):
        ...
        self.canvas = t.Canvas(self.window, width = 2000, height = 550)
        ...
        self.wc = t.Button(self.window, text = 'Worst case', command = lambda : self.generator(False))
...
class Number:
    ...
    def swap(self, other):
        ...
        a.canvas.move(self.rectangle, -xd*5, 0)
        a.canvas.move(other.rectangle, xd*5, 0)
        
        a.canvas.move(self.text, -xd*5, 0)
        a.canvas.move(other.text, xd*5, 0)
...
def choose_pivot(l, p, r, randomized = False):
    if randomized:
        ...
        c = l.index(x)
        l[r], l[c] = l[c], l[r]
        a.canvas.itemconfig(l[r].rectangle, fill = 'yellow')
        l[r].swap(l[c])
    else:
        x = l[r]
        a.canvas.itemconfig(l[r].rectangle, fill = 'yellow')
...
def quicksort(l, p, r, randomized = False):
    if p < r:
        ...
        a.canvas.itemconfig(l[q].rectangle, fill = 'purple')
